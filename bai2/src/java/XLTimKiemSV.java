    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try(Connection con = KetNoi.KNCSDL()){
            ...
            while(rsDanhSach.next()){
                ...
                cn.put("MaSV", rsDanhSach.getInt("MaSV"));
                cn.put("HoTen", rsDanhSach.getString("HoTen"));
                cn.put("NgaySinh", rsDanhSach.getDate("NgaySinh"));
                cn.put("DiemTB", rsDanhSach.getFloat("DiemTB"));
                danhSachSinhVien.add(cn);
            }
            if(hoten !=null && !hoten.trim().isEmpty()){
                ...
                while(rsTimKiem.next()){
                    Map<String,Object> cn = new HashMap<>();
                    cn.put("MaSV", rsTimKiem.getInt("MaSV"));                    
                    cn.put("HoTen", rsTimKiem.getString("HoTen"));
                    cn.put("NgaySinh", rsTimKiem.getDate("NgaySinh"));
                    cn.put("DiemTB", rsTimKiem.getFloat("DiemTB"));
                    ketQuaTimKiem.add(cn);
                }
            }
        } catch (Exception ex) {
            request.setAttribute("error", "Loi ket noi co so du lieu: "+ ex.getMessage());
        }
